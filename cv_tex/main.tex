...
\begin{enumerate}
    ...
    \item \textit{The weak Lefschetz property and mixed multiplicities of monomial ideals}. (2023) \href{https://arxiv.org/abs/2306.13274}{arxiv:2306.13274}. Journal of Algebraic Combiantorics (pending minor revisions)%(submitted to Journal of Algebraic Combinatorics)%Submitted to Journal of Algebraic Combinatorics.
    ...
    \item \textit{Rees algebras, Symbolic powers and Lefschetz properties of squarefree monomial ideals}. (to be submitted in April)
\end{enumerate}
\end{rSection}
