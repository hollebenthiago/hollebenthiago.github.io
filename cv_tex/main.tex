...
\begin{enumerate}
    ...
    \item \textit{The weak Lefschetz property and mixed multiplicities of monomial ideals}. (2023) \href{https://arxiv.org/abs/2306.13274}{arxiv:2306.13274}. (Submitted)%Submitted to Journal of Algebraic Combinatorics.
    ...
    \item \textit{Lefschetz properties of squarefree monomial ideals via Rees algebras}. (to be submitted in April)
\end{enumerate}
\end{rSection}
