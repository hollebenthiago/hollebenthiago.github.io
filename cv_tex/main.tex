...
\begin{rSection}{In progress}
    ...
    \begin{enumerate}[label = {}]
        \item \textit{Computing homotopy type and homological invariants of independence complexes of ternary graphs}. With Sara Faridi.  (preprint, to be submitted October 2023).
