...
\begin{enumerate}[label={}]
    \item Thiago Holleben. (2023). \textit{The weak Lefschetz property and mixed multiplicities of monomial ideals}.  \href{https://arxiv.org/abs/2306.13274}{arxiv link} Submitted to Journal of Algebraic Combinatorics.
    \item Susan M. Cooper, Sara Faridi, Lisa Nicklasson, Adam Van Tuyl, Thiago Holleben. (2023). \textit{The weak Lefschetz property of whiskered graphs}. \href{https://arxiv.org/abs/2306.04393}{arxiv link}. Lefschetz Properties: Current and New Directions, Springer INdAM series, to appear. 
\end{enumerate}
\end{rSection}
...
\begin{rSection}{In progress}
    ...
    \begin{enumerate}[label = {}]
        \item Sara Faridi, Thiago Holleben. \textit{Computing homotopy type and homological invariants of independence complexes of ternary graphs}. (preprint, to be submitted October 2023).
        \item Thiago Holleben. \textit{Rees algebras and Lefschetz properties of squarefree monomial ideals}.
        \item Trung Chau, Art Duval, Sara Faridi, Thiago Holleben, Susan Morey, Liana \c{S}ega.  \textit{Powers of a simplex}.
        \item Sara Faridi, Thiago Holleben. \textit{On the weak Lefschetz properties of squarefree Gotzmann ideals}.
        \item Susan M. Cooper, Sara Faridi, Lisa Nicklasson, Adam Van Tuyl, Thiago Holleben. \textit{Pseudomanifolds, generalized whiskerings and the weak Lefschetz property}.
        \item Manohar Kumar, Thiago Holleben. \textit{Edge ideals of weighted oriented forests via polarization}.
    \end{enumerate}
\end{rSection}
%----------------------------------------------------------------------------------------
...
\begin{rSection}{Presentations}
    \begin{enumerate}[label={}]
        \item \textit{Rees algebras and Lefschetz properties of squarefree monomial ideals}. Stockholm Commutative Algebra seminar. 26th October 2023 (online talk)
