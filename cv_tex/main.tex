...
\begin{enumerate}[label={}]
    ...
    \item Sara Faridi, Thiago Holleben. (2023). Homological invariants of ternary graphs. (in preparation: expected October 2023)
\end{enumerate}
\end{rSection}
%----------------------------------------------------------------------------------------
...
\begin{rSection}{Events attended}
    ...
    \begin{itemize}[label={}]
        \item 10th Heidelberg Laureate Forum 2023 (poster, lightning talk)
